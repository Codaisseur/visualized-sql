      ...
      <div className="line mb-2">
        <div>
          ...
          <div className="info mb-1" style={{ maxWidth: 180 }}>
            Optional! Do you want to select rows from the FROM table if none in
            the JOINed table match up?
          </div>
        </div>
        ...
        <div className="line">
          ...
          <div>
            ...
            <div className="info mb-1" style={{ maxWidth: 400 }}>
              Used to decide whether each pair of rows, one from the FROM table,
              and one from the JOINed table, match up. It's totally possibly for
              multiple matches to happen on the same row, as is often the case
              with a 1:N or N:N relationship.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="line mb-2">
        ...
        <div>
          ...
          <div className="info mb-1" style={{ maxWidth: 240 }}>
            You can add multiple columns here, separated by comma's. What effect
            does this have?
          </div>
        </div>
      </div>
